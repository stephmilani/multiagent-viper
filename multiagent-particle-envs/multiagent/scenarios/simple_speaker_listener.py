...
class Scenario(BaseScenario):
    ...
    def benchmark_data(self, agent, world):
        ...
        # Note(zhicheng): to reproduce the results (targets reached and average distance) in the MADDPG paper
        # Doesn't seem to need this, since reward is already the distance
        # target = world.agents[0].goal_b
        return (rew,)
